...
const FAQS = [
  {
    ...
    a: 'Tap the + button, take a photo or choose from your library, and the app will automatically extract the details.',
  },
  {
    q: 'Is my data private?',
    a: 'Yes. All receipt data is stored locally on your device only.',
  },
  {
    q: 'What if OCR misreads my receipt?',
    a: 'You can manually edit any field after scanning.',
  },
  {
...
export default function ReceiptSupport() {
  return (
    <div style={styles.page}>
      <div style={styles.header}>
        <span style={styles.headerEmoji}>🛟</span>
        <h1 style={styles.headerTitle}>Sales Tax Tracker Support</h1>
