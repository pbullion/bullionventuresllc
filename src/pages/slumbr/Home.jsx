    ...
    <div style={{ backgroundColor: '#0A0A0F', color: '#f0f0f5', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: 'clamp(40px, 8vw, 72px)', fontWeight: 800, margin: '0 0 12px', letterSpacing: '-1px', color: '#fff' }}>
            slumbr
          </h1>
      ...
      {/* Sub-nav */}
      <div style={{ display: 'flex', justifyContent: 'center', gap: 16, padding: '20px 24px', borderBottom: '1px solid #1e1e2e', flexWrap: 'wrap' }}>
        <Link to="/slumbr/privacy" style={{ fontSize: 13, color: '#a0a0b8', padding: '6px 16px', border: '1px solid #2a2a45', borderRadius: 20, fontWeight: 500 }}>Privacy Policy</Link>
        <Link to="/slumbr/support" style={{ fontSize: 13, color: '#a0a0b8', padding: '6px 16px', border: '1px solid #2a2a45', borderRadius: 20, fontWeight: 500 }}>Support</Link>
      </div>
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '80px 24px' }}>
        <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: 800, textAlign: 'center', marginBottom: 12, color: '#fff' }}>
          How it works
        </h2>
          ...
          {[
            ...
            <div key={step} style={{ textAlign: 'center' }}>
              <img
                ...
                alt={title}
                style={{
                  width: '100%', maxWidth: 220, borderRadius: 28, display: 'block', margin: '0 auto 24px',
              ...
              <div style={{
                ...
                width: 28, height: 28, borderRadius: '50%', backgroundColor: '#6c63ff',
                fontSize: 13, fontWeight: 700, marginBottom: 10, color: '#fff',
              }}>
                {step}
              </div>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '80px 24px' }}>
        <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: 800, textAlign: 'center', marginBottom: 48, color: '#fff' }}>
          Everything you need. Nothing you don't.
        </h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
          {[
            { icon: '📺', title: 'Live Video', desc: "Real-time feed from baby's room to your phone, anywhere on your network." },
            { icon: '🔔', title: 'Noise Alerts', desc: 'Instant push notifications when baby stirs. Adjustable sensitivity.' },
            { icon: '🎵', title: 'Lullaby Player', desc: '13+ built-in lullabies. Play from your phone, right through the crib device.' },
            { icon: '🎙️', title: 'Push to Talk', desc: "Speak directly into the baby's room without getting up." },
            { icon: '👨‍👩‍👧', title: 'Family Sharing', desc: 'Invite your partner, grandparent, or nanny with a simple 6-digit code.' },
            { icon: '🌙', title: 'Dark Baby Screen', desc: "The crib device stays pitch black so it never disturbs your baby's sleep." },
          ].map(({ icon, title, desc }) => (
            <div key={title} style={{
              backgroundColor: '#111118', border: '1px solid #1e1e30',
      ...
      <div style={{
        ...
        borderTop: '1px solid #2a2a45', borderBottom: '1px solid #2a2a45',
        ...
        <p style={{ fontSize: 12, color: '#4a4a6a', marginTop: 20 }}>
          Requires iOS 16 or later · iPhone & iPad
        </p>
      </div>

      {/* Footer nav */}
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
        <Link to="/" style={{ fontSize: 13, color: '#6c63ff', fontWeight: 500 }}>← Back to Home</Link>
        <div style={{ display: 'flex', gap: 20 }}>
          <Link to="/slumbr/privacy" style={{ fontSize: 13, color: '#4a4a6a' }}>Privacy Policy</Link>
          <Link to="/slumbr/support" style={{ fontSize: 13, color: '#4a4a6a' }}>Support</Link>
        </div>
      </div>
